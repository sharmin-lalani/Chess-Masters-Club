...
{
	table=document.getElementById("friend");
...
function getlist() 
{
	...
	{
		searchReq.open("GET","Userlist?value="+uname.value,true);
	...
	if (searchReq.readyState == 4 && searchReq.status==200)
{
	...
	for(i=0; i < str.length-1; i++) {
		...
		var suggest = "<tr><td>" + "<a href=profile.jsp?username="+str[i]+">"+str[i] + "</a></td><td><a href=\"SendFriendRequest?username="+str[i]+"\">&nbsp;&nbsp;&nbsp;Send a Request</a></td></tr>";
	...
	<div id="main" class="container">
		...
		<div id="center" >
			<div class="article_wrapper"  style="min-height: 550px;" >
				...
				<table id="friend" style="font-size: 14px;">
				</table>
