	...
	<div id="main" class="container" >
     ...
     <!-- left column -->
		...
		<div class="article_wrapper" style="margin-left:auto; margin-right:auto; margin-bottom:60px; ">
			<div id="status1" align="center" style="color:#900; margin-left:50px;font-weight:bold; font-size:25px;">
			<%
				if(isend.matches("1"))
				out.print("Game over!");
			%>
...
<br />
<div id="status" align="center" style="color:#900; margin-left:50px;font-weight:bold; font-size:25px;">
<%
	if(isend.matches("1"))
	out.print("Game over!");
%>
		...
		<form action="ResignGame" method="post">
		<input id="button" style="padding: 2px 5px;" type="submit" value="Resign Game" />
